...
try:
    os.remove('test_convergence.csv')
except:
    zero=0
...
header='run_no. ' + 'nnmodel ' +  'name_test_data ' + 'no._of_test_data '  + 'mape_(in %) ' + ' male_te ' +'mse ' +  'R-squared ' + '\n'

ff=open('test_convergence.csv','w+')
ff.write(header)
ff.close()            
...
#        print('')
        ...
        ## sub52,10 ax[4][1]  
            ...
            plt.savefig(pngfn)
            ff=open('test_convergence.csv','a')
